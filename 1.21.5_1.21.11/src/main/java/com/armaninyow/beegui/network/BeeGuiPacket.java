...
/**
 * 1.21.5+ version of BeeGuiPacket.
 * Uses the 1.21.5+ NBT API where getters return Optional and
 * getListOrEmpty / getCompoundOrEmpty are used instead of getList(key, type).
 */
