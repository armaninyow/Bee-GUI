...
public class BeeManagementScreen extends Screen {
	...
	// 1.21.2+: EntityType.create() requires a SpawnReason parameter
	...
	// 1.21/1.21.1–1.21.4: keyPressed takes (int keyCode, int scanCode, int modifiers) — no KeyInput class
	@Override
	...
	private void renderBeeTooltip(DrawContext context, BeeGuiPacket.BeeInfo bee, int mouseX, int mouseY) {
		...
		// 1.21.2+: withShadowColor() is available
